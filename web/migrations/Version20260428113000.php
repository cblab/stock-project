...
final class Version20260428113000 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE instrument_buy_signal_snapshot ADD source_run_id INT DEFAULT NULL, ADD available_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE instrument_sepa_snapshot ADD source_run_id INT DEFAULT NULL, ADD available_at DATETIME DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE instrument_epa_snapshot ADD source_run_id INT DEFAULT NULL, ADD available_at DATETIME DEFAULT NULL');
