...
final class EntryEvidenceAggregatorTest extends TestCase
{
    ...
    {
        $samples = [
            EvidenceTradeSampleFixture::closedProfit(), // eligible_full (with snapshots)
    ...
    {
        $samples = [
            EvidenceTradeSampleFixture::closedProfit(['realizedPnlPct' => '0.20']),
            EvidenceTradeSampleFixture::openCampaign(), // excluded, no PnL
        ];
    ...
    public function testMissingPnlExcluded(): void
    {
        $samples = [
            EvidenceTradeSampleFixture::closedProfit(),
            EvidenceTradeSampleFixture::missingPnl(['campaignState' => 'closed_profit']),
        ];
     ...
     */
    private function findBucket(array $results, string $tradeType, string $seedSource): ?object
    {
